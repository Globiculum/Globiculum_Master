      ...
      supabase.functions.invoke("analyze-curriculum", {
        body: {
          formData: {
            ...
            // Explicit target curriculum for RAG registry lookup
            // targetGoal is user-facing text; targetCurriculum is the machine-readable key
        ...
        // ----------------------------------------------------------------------
        // DEBUG: print full RAG / LLM pipeline logs to the browser console
        // ----------------------------------------------------------------------
        console.log("[AssessmentForm] analyze-curriculum response:", analysisResp);
        if (analysisResp?.data?._meta?.debug_logs) {
          console.log("[AssessmentForm] analyze-curriculum debug logs:", analysisResp.data._meta.debug_logs);
          console.table(analysisResp.data._meta.debug_logs);
        }
        if (analysisResp?.data?._meta) {
          console.log("[AssessmentForm] RAG meta:", {
