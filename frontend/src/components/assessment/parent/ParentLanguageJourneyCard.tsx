...
const foreignLabel = (formData: ParentFormData): string =>
...
interface ParentLanguageJourneyCardProps {
...
const ParentLanguageJourneyCard = ({ formData, onFieldChange, onRecordFieldChange }: ParentLanguageJourneyCardProps) => {
  ...
  const selectForeignLanguage = (value: string) => {
    ...
    onFieldChange("foreignLanguageName", value);
    onFieldChange("foreignLanguageLevel", "");
              ...
              {currentId === "foreign" && (
                <>
                  <div className="flex flex-col items-center text-center">
                    ...
                    <h4 className="text-xl font-bold text-foreground">Is your child studying a foreign language?</h4>
                  </div>
                  ...
                  {formData.foreignLanguageName && (
                    <>
                      <p className="mb-2 mt-5 text-center text-xs font-medium text-muted-foreground">What&rsquo;s their level?</p>
...
export default ParentLanguageJourneyCard;
